<%@page import="com.excel.classes.jsp.dataobject.EmployeeDO" isELIgnored="false"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<html>
	<body>

<%-- 		<% 
		java.util.List<EmployeeDO> empDOList = (java.util.List<EmployeeDO>)session.getAttribute("empdetail");
